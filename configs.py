...
🤖 **Mʏ Nᴀᴍᴇ:** [ꜰɪʟᴇꜱ ꜱᴛᴏʀᴇ ʙᴏᴛ](https://t.me/{BOT_USERNAME})

📝 **Lᴀɴɢᴜᴀɢᴇ:** [Pʏᴛʜᴏɴ](https://www.python.org)

📚 **Lɪʙʀᴀʀʏ:** [Pʏʀᴏɢʀᴀᴍ](https://docs.pyrogram.org)

📡 **Hᴏꜱᴛᴇᴅ Oɴ:** [Kᴏʏᴇʙ](https://app.koyeb.com)

🧑🏻‍💻 **Dᴇᴠᴇʟᴏᴘᴇʀ:** [𝒱𝒾𝒮𝐻𝒲𝒜](https://t.me/iTS_ViSHWA14)

👥 **Sᴜᴘᴘᴏʀᴛ:** [𝒱𝒾𝒮𝐻𝒲𝒜](https://t.me/iTS_ViSHWA14)

📢 **Uᴘᴅᴀᴛᴇꜱ:** [𝓜𝓪𝓻𝓪𝓽𝓱𝓲 𝓣𝓿 𝓢𝓮𝓻𝓲𝓪𝓵𝓼](https://t.me/Marathi_Tv_Serialsx)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/iTS_ViSHWA14'>**╰☆☆ 𝒱𝒾𝒮𝐻𝒲𝒜 ☆☆╮** </a>

<a href=''https://t.me/iTS_ViSHWA14>╰☆☆ 𝒱𝒾𝒮𝐻𝒲𝒜 ☆☆╮</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
ᴀʟꜱᴏ ʀᴇᴍᴇᴍʙᴇʀ ᴛʜᴀᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛꜱ ꜰʀᴏᴍ ᴅᴀᴛᴀʙᴀꜱᴇ. ꜱᴏ ʙᴇᴛᴛᴇʀ ᴅᴏɴ'ᴛ ꜱᴛᴏʀᴇ ᴛʜᴏꜱᴇ ᴋɪɴᴅ ᴏꜰ ᴛʜɪɴɢꜱ.
[​D🇴​​🇳​​🇦​​🇹​​🇪​ ​N​​🇴​​🇼​](vishwamore@fam) (UPI)
"""
	LAZY_HOME_TEXT = """
Hᴇʏ, [{}](tg://user?id={})\n\nɪ'ᴍ ᴀ ᴘᴇʀᴍᴀɴᴇɴᴛ **ꜰɪʟᴇ ꜱᴛᴏʀᴇ ʙᴏᴛ**.

Sᴇɴᴅ ᴍᴇ ᴀɴʏ ғɪʟᴇ I ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴀ ᴘᴇʀᴍᴀɴᴇɴᴛ Sʜᴀʀᴀʙʟᴇ Lɪɴᴋ 🔗. I Sᴜᴘᴘᴏʀᴛ Cʜᴀɴɴᴇʟ Aʟꜱᴏ! Cʜᴇᴄᴋ **Aʙᴏᴜᴛ Bᴏᴛ 🤖** Bᴜᴛᴛᴏɴ.

**तुम्हाला काही शंका असेल तर इथे मेसेज करा 👉 - @iTS_ViSHWA14**
"""
	HOME_TEXT = """
Hᴇʏ, [{}](tg://user?id={})\n\nɪ'ᴍ ᴀ ᴘᴇʀᴍᴀɴᴇɴᴛ **ꜰɪʟᴇ ꜱᴛᴏʀᴇ ʙᴏᴛ**.
